...
export const MenuComponent = memo(() => {
    return <ul>
        ...
        <li><NavLink to={'my-error-boundary'}>my-error-boundary</NavLink></li>
        ...
        <li><NavLink to={'name-alert-class-to-functional-component'}>name-alert-class-to-functional-component</NavLink></li>
    </ul>
})
